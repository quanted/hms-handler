...
if __name__=='__main__':
    ...
    model_spec_list=[
        {'lasso':{'max_poly_deg':5,'fit_intercept':False,'inner_cv':{'n_repeats':10,'n_splits':10,n_jobs=1}}},
        {'larslasso':{'max_poly_deg':5,'fit_intercept':False,'inner_cv':{'n_repeats':10,'n_splits':10,n_jobs=1}}},
        {'gbr':{'kwargs':{},'inner_cv':{'n_repeats':10,'n_splits':10,n_jobs=1},
                'param_grid':{
